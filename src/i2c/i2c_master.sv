...
assign scl_o        = serial_clock;
assign scl_t        = ~serial_clock_output_enable;
assign sda_o        = serial_data;
assign sda_t        = ~serial_data_output_enable;
...
assign state_dbg = state[3:0];
assign process_dbg = process_counter;
            ...
            if (divider_tick) begin
                case (process_counter)
                    ...
                    1: begin
                        ...
                        if (scl_i || !CHECK_FOR_CLOCK_STRETCHING) begin
                            _process_counter    = 2;
